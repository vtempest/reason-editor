...
import { UserPlus, Users, Mail, X, Crown, Shield, Eye, Edit3, Link2, Globe, Lock } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <Select value={newRole} onValueChange={(value: 'viewer' | 'editor') => setNewRole(value)}>
